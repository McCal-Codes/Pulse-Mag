      ...
      initialValue: [
        {
          ...
          body: [
            ...
            },
            {
              ...
              _key: 'cs-sanity-2',
              style: 'normal',
              children: [{ _type: 'span', _key: 'cs-sanity-2-s', marks: ['strong'], text: 'Issues' }, { _type: 'span', _key: 'cs-sanity-2-s2', text: ' — Create magazine issues and upload PDF files for the flipbook viewer' }],
            },
            {
              _type: 'block',
              _key: 'cs-sanity-3',
              style: 'normal',
              children: [{ _type: 'span', _key: 'cs-sanity-3-s', marks: ['strong'], text: 'Authors' }, { _type: 'span', _key: 'cs-sanity-3-s2', text: ' — Create writer/artist profiles for magazine contributors' }],
            },
            {
              _type: 'block',
              _key: 'cs-sanity-4',
              style: 'normal',
              children: [{ _type: 'span', _key: 'cs-sanity-4-s', marks: ['strong'], text: 'Posts' }, { _type: 'span', _key: 'cs-sanity-4-s2', text: ' — Magazine articles, fiction, poetry, essays' }],
            },
            {
              _type: 'block',
              _key: 'cs-sanity-5',
              style: 'normal',
              children: [{ _type: 'span', _key: 'cs-sanity-5-s', marks: ['strong'], text: 'Events' }, { _type: 'span', _key: 'cs-sanity-5-s2', text: ' — Reading series, workshops, launch parties' }],
            },
            {
              _type: 'block',
              _key: 'cs-sanity-6',
              style: 'normal',
              children: [{ _type: 'span', _key: 'cs-sanity-6-s', marks: ['strong'], text: 'Pages' }, { _type: 'span', _key: 'cs-sanity-6-s2', text: ' — Static content pages (About, Submit, etc.)' }],
            },
            {
              _type: 'block',
              _key: 'cs-summary',
